...
export function MatchTabs() {
  ...
  return (
    <TabLinks>
      ...
      <TabLink url={RoutePath.MatchAntiFlash}>
        <Trans context="Tab link">Anti-flash</Trans>
      </TabLink>
      <TabLink url={RoutePath.MatchSmokeTracking}>
        <Trans context="Tab link">Smoke tracking</Trans>
      </TabLink>
      <TabLink url={RoutePath.MatchAimToggle}>
        <Trans context="Tab link">Aim toggle</Trans>
      </TabLink>
      <TabLink url={RoutePath.MatchAimOutlier}>
        <Trans context="Tab link">Aim outlier</Trans>
      </TabLink>
